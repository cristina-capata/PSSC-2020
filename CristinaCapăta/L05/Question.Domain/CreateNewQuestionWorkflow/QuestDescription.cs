...
{
    [AsChoice]
    public static partial class QuestDescription
    {
        ...
        public class UnpublishedQuestion : IQuestion_Description
        {
            ...
            public static Result<UnpublishedQuestion> Create(string question,List<string>tag)
            {
                if (IsQuestionValid(question))
                {
                    ...
                    {
                        return new Result<UnpublishedQuestion>(new InvalidQuestTagException(tag));
                    }
                }
                else
                {
                    return new Result<UnpublishedQuestion>(new InvalidQuestCharException(question));
                }
            }
